...
task_configs = {
    ...
    'quote and question': {
        'evaluation_data_dir': '../allennlp/eval/race/bi_ranker.best_epoch/test',  # '../allennlp/eval/race/cross_ranker.last_epoch/test'
    ...
    'quotes and question': {
        'evaluation_data_dir': '../allennlp/eval/race/bi_ranker.best_epoch/test',
        'num_conversations': 25,

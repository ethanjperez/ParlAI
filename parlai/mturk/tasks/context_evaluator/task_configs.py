...
task_configs = {
    ...
    'quote and question': {
        'evaluation_data_dir': '../allennlp/eval/race/fasttext.o/test',  # '../allennlp/eval/dream/bi_ranker.last_epoch/test'
    ...
    'quotes and question': {
        ...
        'evaluation_data_dir': '../allennlp/eval/dream/bi_ranker.last_epoch/test',
        'num_conversations': 25,
